    ...
    <>
      <div className="text-gray-950 shadow-md sticky  top-0 z-30 w-full bg-white">
        ...
        <div
          ...
          className={
            nav
              ? "overflow-y-hidden md:hidden ease-in z-30 duration-300 absolute text-gray-300 left-0 top-0 w-full h-screen bg-black/100 px-4 py-7 flex flex-col"
        ...
        >
          ...
          <ul className="h-full w-full text-center pt-18">
            <li className="text-2xl mt-12 text-white py-4">
              <NavLink as={NavLink} to="/">
              We are Cratemate AI
              </NavLink>
            </li>
